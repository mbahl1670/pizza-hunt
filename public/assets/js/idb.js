...
request.onsuccess = function(event) {
    ...
    // check if app is online, if yes run uploadPizza() functoin to send all local db data to api
    if (navigator.onLine) {
        uploadPizza();
    }
};
...
function uploadPizza() {
    ...
    getAll.onsuccess = function() {
        // if there was data in indexDb's store, let's sendit to the api server
